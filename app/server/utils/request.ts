...
const answerPromots = `帮我将这个字符串转化为json数据，以${process.env.ANSWER_TENPLATE}为转化的模板，只给我转化好的json数据，,特别注意你除了回复我转好的json以外，其他任何话都不要有,前面一部分是单选题后面必是多选然后再是单选，这样循环,id必须是dpxxxx（如dp0001）`;
        ...
        messages: [
            ...
            },
            {
                ...
                content: [
                    {
                        type: 'text',
                        text: questions + questionPromots
                    },
                ],
            },
        ],
